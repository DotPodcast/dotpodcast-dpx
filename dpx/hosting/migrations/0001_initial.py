# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-02-19 15:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', models.TextField(blank=True, null=True)),
                ('kind', models.CharField(choices=[(b'trailer', b'trailer'), (b'episode', b'episode'), (b'bonus', b'bonus')], max_length=10)),
        ...
        migrations.CreateModel(
            name='Player',
            fields=[
                ('tokenpair_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='hosting.TokenPair')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app_logo', models.URLField(blank=True, max_length=512, null=True)),
                ('kind', models.CharField(choices=[(b'c', b'casual listener'), (b's', b'subscriber')], max_length=1)),
        ...
        migrations.AddField(
            ...
            name='podcast',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subscribers', to='hosting.Podcast'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='player',
            name='podcast',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='players', to='hosting.Podcast'),
        ),
